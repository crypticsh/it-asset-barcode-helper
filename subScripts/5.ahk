...
Run, %SnipeITURL%/accessories/%GUICodeScanned%

imagesearch1:				; Image search to look for Select a User (to be able to click it)
	Loop {
		ImageSearch, FoundX, FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight, *50 %A_ScriptDir%\images\%ChromeScaling%-Search.PNG
			if ErrorLevel = 0
				{
